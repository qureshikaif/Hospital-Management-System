...
public class DoctorRatingJFrame extends javax.swing.JFrame {

    /**
     * Creates new form DoctorRatingJFrame
     */
    String doctorName;
    public DoctorRatingJFrame() {
        initComponents();
        centerFrame();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("How would you rate this doctor out of 10?");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(119, 119, 119)
                        .addComponent(ratingSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            // Retrieve the value from the NetBeans slider
            int rating = ratingSlider.getValue(); 

            // Prepare the SQL query
            String sql = "UPDATE Doctors SET Ratings = ? WHERE Username = ?";

            // Create a PreparedStatement object to execute the query
            PreparedStatement statement = connection.prepareStatement(sql);

            // Set the parameter value for the rating
            ...
            if (rowsUpdated > 0) {
                ...
                JOptionPane.showMessageDialog(this, "Failed to update rating.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorRatingJFrame().setVisible(true);
            }
        });
    }
